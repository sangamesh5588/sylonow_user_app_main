-- Fix the RPC function to match the correct formula from the image
...
BEGIN
    ...
    -- add-ons with all taxes = addons discounted price + 3.54%
    ...
    -- Calculate total commission - ONLY if vendor has GST
